#ifndef Z1_CONTROLLER_MATHTYPES_H
#define Z1_CONTROLLER_MATHTYPES_H
...
// 3x3 Identity Matrix
#define Z1_CONTROLLER_I3 Eigen::MatrixXd::Identity(3, 3)

// 6x6 Identity Matrix
#define Z1_CONTROLLER_I6 Eigen::MatrixXd::Identity(6, 6)

// 12x12 Identity Matrix
#define Z1_CONTROLLER_I12 Eigen::MatrixXd::Identity(12, 12)

// 18x18 Identity Matrix
#define Z1_CONTROLLER_I18 Eigen::MatrixXd::Identity(18, 18)

// Dynamic Size Matrix
using MatX = typename Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>;

#include "common/math/mathTypesCommon.h"
